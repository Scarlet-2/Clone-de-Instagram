    ...
    return (
        <div className="app__header">
            <div className="app__headerWrapper">
                ...
                <div>
                    <forms>
                        <input typeof="search" placeholder="Pesquisar" className="pesquisarHeader" />
                    </forms>
                </div>

                {/* Esse codigo foi tirado do Diego */}
                <div className="app__headerButtons">
                    <button className="text__button">
                        <svg aria-label="Página inicial" class="_8-yf5 " color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
                    ...
                    <button className="text__button">
                        <svg aria-label="Nova publicação" class="_8-yf5 " color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
                    ...
                    <button className="text__button">
                        <svg aria-label="Encontrar pessoas" class="_8-yf5 " color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
                    ...
                    <button className="text__button">
                        <svg aria-label="Feed de atividades" class="_8-yf5 " color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
                    ...
                    {/* Fim do codigo do diego */}

                    <button className="text__button"><img src="https://img.icons8.com/external-kiranshastry-lineal-kiranshastry/24/000000/external-user-interface-kiranshastry-lineal-kiranshastry.png" alt=" "/></button>
                </div>
